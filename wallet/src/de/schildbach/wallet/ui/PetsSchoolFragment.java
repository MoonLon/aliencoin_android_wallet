 ...
 */
public class PetsSchoolFragment extends Fragment implements LoaderCallbacks<List<Transaction>>,
    ...
    private static final Logger log = LoggerFactory.getLogger(PetsSchoolFragment.class);
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.pets_school_fragment, container, false);
...
//        filterMenuItem = menu.findItem(R.id.wallet_transactions_options_filter);
    ...
    public void onWarningClick() {
        switch (warning()) {
        case BACKUP:
            ((PetsSchoolActivity) activity).handleBackupWallet();
            break;
